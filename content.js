...
$$`
  ...
  ui: {
    "zh-Hans": {
      ...
      measure: "行宽",
      measureNarrow: "紧凑",
      measureComfortable: "舒适",
      measureWide: "宽屏",
      demoDocumentName: "MarkView 示例文档",
      pastedDocumentName: "粘贴的 Markdown",
      sourceDemo: "示例",
      sourceFile: "本地文件",
      sourceUrl: "网络链接",
      sourcePaste: "粘贴内容",
      ...
      copyMarkdown: "复制原文",
      backToDemo: "返回示例",
      copied: "已复制 Markdown 原文",
      copyFailed: "复制失败，请检查浏览器权限",
      statusLocal: "本地离线版",
      statusOffline: "离线可用",
      statusReady: "本地就绪",
      linkModalTitle: "打开 Markdown 链接",
      linkModalDesc: "读取后只在当前浏览器中处理，不会上传文档。",
      linkInputLabel: "链接地址",
      linkNote: "远程站点需要允许跨域读取；本地文件请使用“打开文件”。",
      cancel: "取消",
      loadLink: "读取链接",
      linkLoaded: "链接内容已读取",
      offlineLinkError: "当前离线，无法读取网络链接",
      invalidUrl: "请输入有效的链接地址",
      unsupportedFile: "请选择 .md、.markdown 或 .txt 文件",
      fileReadError: "无法读取这个本地文件",
      diagramError: "流程图渲染失败",
      offlineSetupError: "离线缓存初始化失败",
      installed: "MarkView 已安装",
    ...
    en: {
      ...
      closeOutline: "Collapse outline",
      measure: "Line width",
      measureNarrow: "Narrow",
      measureComfortable: "Comfortable",
      measureWide: "Wide",
      demoDocumentName: "MarkView demo document",
      pastedDocumentName: "Pasted Markdown",
      sourceDemo: "Demo",
      ...
      copyMarkdown: "Copy source",
      backToDemo: "Back to demo",
      copied: "Markdown copied",
      copyFailed: "Copy failed. Check browser permission.",
      statusLocal: "Local offline",
      statusOffline: "Offline ready",
      statusReady: "Local ready",
      linkModalTitle: "Open Markdown URL",
      linkModalDesc: "The document is processed only in this browser.",
      linkInputLabel: "URL",
      linkNote: "Remote sites must allow cross-origin reads. Use Open File for local documents.",
      cancel: "Cancel",
      loadLink: "Load URL",
      linkLoaded: "Markdown loaded",
      offlineLinkError: "You are offline. A web URL cannot be loaded.",
      invalidUrl: "Enter a valid URL",
      unsupportedFile: "Choose a .md, .markdown, or .txt file",
      fileReadError: "This local file could not be read",
      diagramError: "The diagram could not be rendered",
      offlineSetupError: "Offline cache setup failed",
      installed: "MarkView installed",
